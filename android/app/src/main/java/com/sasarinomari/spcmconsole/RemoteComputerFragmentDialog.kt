...
class RemoteComputerFragmentDialog(private val api: APIClient) : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        rootView.button_power_on.setOnClickListener {
            api.wakeup {
                Toast.makeText(api.context, api.context.getString(R.string.Confirm_Wakeup), Toast.LENGTH_LONG).show()
            }
            this.dismiss()
        }
        ...
        rootView.button_power_off.setOnClickListener {
            api.shutdown {
                Toast.makeText(api.context, api.context.getString(R.string.Confirm_Shutdown), Toast.LENGTH_LONG).show()
            }
            this.dismiss()
        }
